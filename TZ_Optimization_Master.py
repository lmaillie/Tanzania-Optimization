...
#Just to make it work without absolute paths
import os
#abspath = os.path.abspath(__file__)
#dname = os.path.dirname(abspath)
#os.chdir(os.path.dirname(os.path.realpath(sys.argv[0])))

os.chdir("/home/matthew/GIT/Python/Tanzania-Optimization/")
...
file = ogr.Open("./Data/TZ_CentroidsWith2012Pop_UTM.shp") #CHANGE FILE PATH
...
LIST_ROAD_SEG = []
file = ogr.Open("./Data/roads_utm.shp") #CHANGE FILE PATH
#print(file.exists('./Data/roads_utm.shp'))
shape = file.GetLayer(0)
for a in l:
    feature = shape.GetFeature(a)
...
#for a in l:
#    file = ogr.Open("./Data/health_facilities_aUREmdl_UTM.shp")  #CHANGE FILE PATH
#    shape = file.GetLayer(0)
#    feature = shape.GetFeature(a)
#    
#    if feature == None:
